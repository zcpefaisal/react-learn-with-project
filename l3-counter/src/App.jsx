...
function App() {
  ...
  // const [counter, setCounter] = useState(0) // set is a convension
  const [counter, faisalCounter] = useState(10) // 10 is the default value of counter [counter is variable, faisalCounter is function of counter set]
  ...
  return (
    ...
    {/* UI updata control form React and that backend works is hooks  */}
      ...
      <button
      onClick={increassValue}
      >Incress</button>

      <button
      onClick={decressValue}
      >Decress</button>
